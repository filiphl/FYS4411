...
where $T$ is the transition matrix for a system\footnote{That is, the probability of a change from one system state to another.}, and $A$ is the acceptance matrix\footnote{The  probability of accepting the proposed transition.}.

\subsubsection{Brute sampling Metropolis sampling}
In brute force Metropolis sampling, it is assumes (apporximated) that $T_{i\rightarrow j}= T_{j\rightarrow i}$. Inserted above, this gives: 
...
The standard Metropolis algorithm accepts approximately half of the proposed moves. 
...
By utilizing \eqref{importanceSamplingMove} when proposing new moves they will be to areas where the wavefunction is large, i.e. there is a large probability. 
...
\begin{table}[H]
  ...
  \begin{tabular}{ | c | c | c | c | c | c |}
    ...
    \hline
    100& 1& 50& 50& e-11& 4.8  \\*
    \hline
    100& 2& 100& 100& 1.3e-09& 5.5 \\*
    \hline
    100& 3& 150 &150 &8.0e-09& 7.0  \\*
    \hline
    500& 1& 250& 250& 4.7e-08& 35.3  \\*
    \hline
    500& 2& 500& 500& 4.9e-07& 60.0  \\*
    \hline
    500& 3& 750 &750 &       &93.1   \\*
    \hline
  \end{tabular}
