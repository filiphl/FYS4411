...
In figure \ref{fig:blocking_full} below are the blocking runs for 10, 50 and 100 particles. From the graphs, one can see the block size corresponding to the correct correlation time is about $500\times\Delta t$, $2000\times\Delta t$ and $----\times\Delta t$. Therefore, the standard deviation of each case is:
...
\begin{figure}[H]
	\centering
	\subcaptionbox{10 particles.}{\includegraphics[scale=0.4]{../modifiedMortenCode/figures/N=10_D=3_alpha=0498783_steps=1e6_full.png}}
	\subcaptionbox{50 particles.}{\includegraphics[scale=0.4]{../modifiedMortenCode/figures/N=50_D=3_alpha=0498783_steps=1e6_full_1.png}}
	\subcaptionbox{100 particles.}{\includegraphics[scale=0.4]{../modifiedMortenCode/figures/N=50_D=3_alpha=0498783_steps=1e6_full_1.png}}
...
This is what we call the one-body density. SOMETHING ABOUT OUR WAVEFUNCTION BEING A PRODUCT OF INDEPENDENT WAVEFUNCTIONS.

For the case of 10 particles in the elliptical trap, $\alpha = $ blah and $\beta = 2.82843$, the one body density was found to be as shown in figure blah4.
