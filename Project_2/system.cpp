...
void System::openPositionFile()
{
    ...
    //system(cmd);
    sprintf(m_oldPositionFileName, "dataFiles/positionN%dw%dSe%d.bin", m_numberOfParticles, (int)(m_waveFunction->getOmega()*100), (int) log10(m_numberOfMetropolisSteps));
