...
\end{figure}
		\begin{table}[H]
			\begin{center}
				\caption{Expectation values of local energy, kinetic energy and potential energy for several number of electrons $N$ and wave frequency $\omega$. The standard deviation $\sigma$ is of the expectation value of the  }
	...
	\begin{figure}[H]
		...
		\caption{Onebody density and radial distribution from different values of N.}
